jpgtojpg MATLAB Python Package
...
2. Installing the jpgtojpg Package

A. Change to the directory that contains the file setup.py and the subdirectory jpgtojpg. 
...
3. Using the jpgtojpg Package

The jpgtojpg package is on your Python path. To import it into a Python script or 
session, execute:
