...
/**
 * The <code>helloclassRemote</code> class provides a Java RMI-compliant interface to 
 * MATLAB functions. The interface is compiled from the following files:
 * <pre>
 *  E:\MATLAB_2017a\Project\hello.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>helloclassRemote</code> 
 ...
 * generate RMI server proxy objects for instances of hello.helloclass.
 */
public interface helloclassRemote extends Poolable
{
    /**
