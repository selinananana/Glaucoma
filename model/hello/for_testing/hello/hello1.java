...
/**
 * The <code>hello1</code> class provides a Java interface to MATLAB functions. 
 * The interface is compiled from the following files:
 * <pre>
 *  E:\MATLAB_2017a\Project\hello.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>hello1</code> instance 
 * when it is no longer needed to ensure that native resources allocated by this class 
 * are properly freed.
 * @version 0.0
 */
public class hello1 extends MWComponentInstance<hello1>
{
    /**
     ...
     */
    private hello1 (final MWMCR mcr) throws MWException
    {
        super(mcr);
        // add this to sInstances
        synchronized(hello1.class) {
            sInstances.add(this);
        }
    }

    /**
     * Constructs a new instance of the <code>hello1</code> class.
     * @throws MWException An error has occurred during the function call.
     */
    public hello1() throws MWException
    {
    ...
    /**
     * @deprecated Please use the constructor {@link #hello1(MWComponentOptions componentOptions)}.
     * The <code>com.mathworks.toolbox.javabuilder.MWComponentOptions</code> class provides an API to set the
     * path to the component.
     * @param pathToComponent Path to component directory.
     * @throws MWException An error has occurred during the function call.
     */
    public hello1(String pathToComponent) throws MWException
    {
        this(HelloMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    
    /**
     * Constructs a new instance of the <code>hello1</code> class. Use this constructor 
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public hello1(MWComponentOptions componentOptions) throws MWException
    {
